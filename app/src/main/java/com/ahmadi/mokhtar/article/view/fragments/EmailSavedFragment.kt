...
import kotlinx.android.synthetic.main.fragment_emailed.progress
import kotlinx.android.synthetic.main.fragment_emailed.recyclerView
import kotlinx.android.synthetic.main.fragment_viewed.*


class EmailSavedFragment : Fragment() , EmailedAdapter.CallBack {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(activity!!.applicationContext as App) {
            viewModel = androidx.lifecycle.ViewModelProviders.of(this@EmailSavedFragment,
    ...
    private fun initObserver() {
        ...
        viewModel.emailedResult.observe(this, Observer<List<ResultEmail>>() {
            ...
            recyclerView.adapter = EmailedAdapter(it,this,"saved")
        })
