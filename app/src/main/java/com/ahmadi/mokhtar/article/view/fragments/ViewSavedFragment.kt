...
class ViewSavedFragment : Fragment() , ViewedAdapter.CallBack{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(activity!!.applicationContext as App) {
            viewModel = androidx.lifecycle.ViewModelProviders.of(this@ViewSavedFragment,
    ...
    private fun initObserver() {
        ...
        viewModel.viewedResult.observe(this, Observer<List<ResultView>>() {
            ...
            recyclerView.adapter = ViewedAdapter(it,this ,"saved")
        })
